<template>
  <div>
    ...
    <p>
      <img
        src="/img/about/shema1.jpg"
        alt="ATIOP — сервис управления задачами"
    ...
    <p>
      ...
      <router-link to="/login#in" tag="a" title="Авторизоваться"
        >авторизоваться</router-link
      >&nbsp;или
      <router-link to="/login#reg" tag="a" title="Зарегистрироваться"
